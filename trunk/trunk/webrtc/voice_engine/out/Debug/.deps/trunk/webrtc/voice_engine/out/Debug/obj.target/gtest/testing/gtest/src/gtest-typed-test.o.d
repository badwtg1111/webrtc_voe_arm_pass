cmd_trunk/webrtc/voice_engine/out/Debug/obj.target/gtest/testing/gtest/src/gtest-typed-test.o := g++ '-D_FILE_OFFSET_BITS=64' '-DUSE_LINUX_BREAKPAD' '-DCHROMIUM_BUILD' '-DUSE_DEFAULT_RENDER_THEME=1' '-DUSE_LIBJPEG_TURBO=1' '-DUSE_NSS=1' '-DENABLE_ONE_CLICK_SIGNIN' '-DGTK_DISABLE_SINGLE_INCLUDES=1' '-DENABLE_REMOTING=1' '-DENABLE_WEBRTC=1' '-DENABLE_PEPPER_THREADING' '-DENABLE_CONFIGURATION_POLICY' '-DENABLE_INPUT_SPEECH' '-DENABLE_NOTIFICATIONS' '-DENABLE_GPU=1' '-DENABLE_EGLIMAGE=1' '-DUSE_SKIA=1' '-DENABLE_TASK_MANAGER=1' '-DENABLE_EXTENSIONS=1' '-DENABLE_PLUGIN_INSTALLATION=1' '-DENABLE_PLUGINS=1' '-DENABLE_SESSION_SERVICE=1' '-DENABLE_THEMES=1' '-DENABLE_BACKGROUND=1' '-DENABLE_AUTOMATION=1' '-DENABLE_GOOGLE_NOW=1' '-DENABLE_LANGUAGE_DETECTION=1' '-DENABLE_PRINTING=1' '-DENABLE_CAPTIVE_PORTAL_DETECTION=1' '-DENABLE_MANAGED_USERS=1' '-DGTEST_HAS_RTTI=0' '-DDYNAMIC_ANNOTATIONS_ENABLED=1' '-DWTF_USE_DYNAMIC_ANNOTATIONS=1' '-D_DEBUG' -Itesting/gtest -Itesting/gtest/include  -fstack-protector --param=ssp-buffer-size=4 -pthread -fno-exceptions -fno-strict-aliasing -Wno-unused-parameter -Wno-missing-field-initializers -fvisibility=hidden -pipe -fPIC -Wno-format -Wno-unused-result -O0 -g -fno-rtti -fno-threadsafe-statics -fvisibility-inlines-hidden -Wno-deprecated -MMD -MF trunk/webrtc/voice_engine/out/Debug/.deps/trunk/webrtc/voice_engine/out/Debug/obj.target/gtest/testing/gtest/src/gtest-typed-test.o.d.raw  -c -o trunk/webrtc/voice_engine/out/Debug/obj.target/gtest/testing/gtest/src/gtest-typed-test.o testing/gtest/src/gtest-typed-test.cc
trunk/webrtc/voice_engine/out/Debug/obj.target/gtest/testing/gtest/src/gtest-typed-test.o: \
